    ...
    <div className="my-24 mx-auto md:px-6">
      ...
      <section className="mb-32 text-center">
        <div className="max-w-md mx-auto mb-14 text-center">
          <h1 className="text-4xl font-semibold mb-6 lg:text-5xl">Meet <span className="text-indigo-600"> The Team</span></h1>
        ...
        <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12">
          <div className="mb-6 lg:mb-0">
            <div
              ...
              <div className="relative overflow-hidden bg-cover bg-no-repeat">
                <img src="team_member_1.jpeg" className="w-full rounded-t-lg" alt="Rewa Joshi"/>
                <a href="#!">
              ...
              <div className="p-6">
                ...
                <p className="mb-4 text-neutral-500 dark:text-neutral-300">GCP Cloud Engineer</p>
          ...
          <div className="mb-6 lg:mb-0">
            <div
              className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              <div className="relative overflow-hidden bg-cover bg-no-repeat">
                <img src="team_member_2.jpeg" className="w-full rounded-t-lg" alt="Sharon Vijay"/>
                <a href="#!">
                  <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"></div>
                </a>
                <svg className="absolute text-white dark:text-neutral-700  left-0 bottom-0" xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="p-6">
                ...
                <p className="mb-4 text-neutral-500 dark:text-neutral-300">Full Stack Developer</p>
                <ul className="mx-auto flex list-inside justify-center">
                  <a href="#!" className="px-2">
                    {/* <!-- Facebook --> */}
          ...
          <div className="">
            ...
            className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
            <div className="relative overflow-hidden bg-cover bg-no-repeat">
              <img src="team_member_3.jpeg" className="w-full rounded-t-lg" alt="Vishwarup Kashyap"/>
              <a href="#!">
                <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"></div>
              </a>
              <svg className="absolute text-white dark:text-neutral-700  left-0 bottom-0" xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="p-6">
              ...
              <p className="mb-4 text-neutral-500 dark:text-neutral-300">Tech Dude</p>
              <ul className="mx-auto flex list-inside justify-center">
                <a href="#!" className="px-2">
                  {/* <!-- Facebook --> */}
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary dark:text-primary-400"
